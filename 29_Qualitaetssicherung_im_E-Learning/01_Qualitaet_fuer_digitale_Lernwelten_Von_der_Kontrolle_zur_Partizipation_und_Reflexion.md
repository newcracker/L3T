<!-- filename: 01_Qualitaet_fuer_digitale_Lernwelten_Von_der_Kontrolle_zur_Partizipation_und_Reflexion.md -->
...
| Traditionelle Lernwelten | Neue/zukünftige Lernwelten |
| --- | --- |
| Qualität wird durch Expertinnen und Experten beurteilt | Qualität wird von Lernenden und Peers beurteilt |
| Lernplattform | Personal Learning Environment |
| Von Expertinnen und Experten erstellte Lerninhalte | Von Lernenden erstellte Inhalte |
| Curricularer Aufbau | Portfolios (Lerntagebücher) |
| Fokus auf Kursstruktur und Content | Fokus auf Kommunikation und Interaktion |
| Verfügbarkeit von Tutorinnen und Tutoren | Interaktion zwischen allen Beteiligten |
| Multimedia (Interaktivität) | Austausch durch Soziale Netzwerke und Communities of Practice |
